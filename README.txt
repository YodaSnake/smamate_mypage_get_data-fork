【2024/12/28 追記】
スマメイト30期にて、ウェブサイトに一時的な仕様変更がありました。
仕様がもとに戻るまでは本プログラムは機能しません。ご了承ください。
仕様変更について:https://smashmate.net/diary/15302/
...
--------------------------------------------------------------------------------------------
※ver1.04まではほーずき氏（twitter:@428_hzk）の活動によるものです。
--------------------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------------------
※ver2.12まではYON氏（twitter:@yoyoyo_4、github:yoyoyo4）の活動によるものです。
以下はyoyoyo4氏のリポジトリ
https://github.com/yoyoyo4/smamate_mypage_get_data
--------------------------------------------------------------------------------------------
ver2.13 2023/12/31:出力に対戦相手の情報を追加
ver2.14 2024/03/02:対戦相手が初戦の場合に対戦相手の情報を取得できない問題を修正。メイトページが混雑中の場合に30秒後に対戦相手の情報を再取得するように変更。
